...
def show_text():
    ...
    if new_window is None or not new_window.winfo_exists():
        ...
        for x_offset in (-1, 0, 1):
            for y_offset in (-1, 0, 1):
                if x_offset != 0 or y_offset != 0:
                    canvas.create_text(200 + x_offset, 60 + y_offset, text=input_text, font=("Arial", 25, "bold"),
                                       fill='black', width=380, justify='center')
                    canvas.create_text(200 + x_offset, 140 + y_offset, text=translated_text, font=("Arial", 25, "bold"),
                                       fill='black', width=380, justify='center')
        canvas.create_text(200, 60, text=input_text, font=("Arial", 20, "bold"), fill='white', width=380,
                           justify='center')
        canvas.create_text(200, 140, text=translated_text, font=("Arial", 20, "bold"), fill='white', width=380,
                           justify='center')
    else:
        # 更新結果顯示區域的文本
        ...
        for x_offset in (-1, 0, 1):
            for y_offset in (-1, 0, 1):
                if x_offset != 0 or y_offset != 0:
                    canvas.create_text(200 + x_offset, 60 + y_offset, text=input_text, font=("Arial", 20, "bold"),
                                       fill='black', width=380, justify='center')
                    canvas.create_text(200 + x_offset, 140 + y_offset, text=translated_text, font=("Arial", 20, "bold"),
                                       fill='black', width=380, justify='center')
